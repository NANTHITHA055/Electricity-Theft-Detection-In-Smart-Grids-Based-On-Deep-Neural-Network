...
le = LabelEncoder()
dataset = pd.read_csv('C:\Users\dhina\OneDrive\Desktop\STREAMLIT\myenv\ElectricityTheftDetectionProject\ElectricityTheft.csv')
...
test = pd.read_csv('C:\Users\dhina\OneDrive\Desktop\STREAMLIT\myenv\ElectricityTheftDetectionProject\test.csv')
